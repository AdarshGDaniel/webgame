...
function deskToColor() {
  toColor("#desk .st0", "#ffcc00");
}

function deskToWhite() {
  toColor("#desk .st0", white);
}
function cpuToColor() {
  toColor("#hard-drive .st0", turquoiseBlueColor);
}

function cpuToWhite() {
  toColor("#hard-drive .st0", white);
}
function bookToColor() {
  toColor("#fishbooks .st0", turquoiseBlueColor);
}

function bookToWhite() {
  toColor("#fishbooks .st0", white);
}
function serverToColor() {
  toColor("#servers .st0", turquoiseBlueColor);
}

function serverToWhite() {
  toColor("#servers .st0", white);
}
function fishToColor() {
  toColor("#fishbooks .st0", turquoiseBlueColor);
}

function fishToWhite() {
  toColor("#fishbooks .st0", white);
}
function plantToColor() {
  toColor("#plant .st0", turquoiseBlueColor);
}

function plantToWhite() {
  toColor("#plant .st0", white);
}
function phoneToColor() {
  toColor("#phone .st0", turquoiseBlueColor);
}

function phoneToWhite() {
  toColor("#phone .st0", white);
}
function ampToColor() {
  toColor("#servers .st0", turquoiseBlueColor);
}
...
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout",  deskToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", deskToWhite);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", plantToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", plantToWhite);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", bookToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", bookToWhite);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", ampToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", ampToWhite);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", fishToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", fishToWhite);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", phoneToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", phoneToWhite);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", serverToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", serverToWhite);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", cpuToColor);
document
  .getElementById("puzzlerBtn")
  .addEventListener("mouseout", cpuToWhite);

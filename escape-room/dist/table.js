...
$(document).ready(function() {
	if(globalVariable.flag_desk != 1){
		...
		function readURL(input) {
			...
			document.getElementById('container').innerHTML="You Solved!";
		}
});


function finish(){
    globalVariable2.final = 1;
	document.getElementById('container').innerHTML="Key: GGWP_Evogen_23";
}